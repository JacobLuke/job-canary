...
DATABASES = {
    'default': {
        ...
        'NAME': 'jobcanary.sqlite3',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'x(=2ju31e+7ul^tg0xy)y0_221k-c35*arzbrz7hn$!x0t(opq'
